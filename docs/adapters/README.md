...
compatibility form are supported in v0.2.2. Upgrade comparisons also preserve adapter
...
No real project adapter is implemented in the pilot release. The v0.2.2 harness uses only
