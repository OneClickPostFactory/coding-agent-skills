...
compatibility form are supported in v0.1.6. Upgrade comparisons also preserve adapter
...
No real project adapter is implemented in the pilot release. The v0.1.6 harness uses only
